    ...
    render() {
        ...
        if (this.props.handleUserInput) {
            ...
            */      
            searchbar =
                <div>
                    輸入使用者姓名:<input type="text" onChange={this.handleChange} 
                    ref={(input)=> {this.userName =input} }/>
                    <button onClick={this.props.handleBtnClick}>查詢</button><br />
                    輸入專案名稱:  <input type="text" onChange={this.handleChange}
                    ref={(input)=> {this.filterRepoName = input}} /><br />
                    <input type="checkbox" onChange={this.handleChange} 
                    ref={(input)=> {this.isBelow20 = input}}/>只顯示fork次數大於20的專案
                </div>
            ...
            searchbar =
                <div>
                    ...
                    <button onClick={this.props.handleBtnClick}>查詢</button><br />
                    輸入專案名稱:  <input type="text" onChange={this.props.handleReposChange} /><br />
